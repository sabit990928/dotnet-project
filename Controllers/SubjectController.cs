...
namespace stable.Controllers
{
    public class SubjectController : Controller
    {
        ...
        {
            var projectContext = _context.Subjects.Include(s => s.Syllabus);
        ...
        {
            ViewData["SyllabusId"] = new SelectList(_context.Syllabuss, "Id", "Id");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,SyllabusId")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
